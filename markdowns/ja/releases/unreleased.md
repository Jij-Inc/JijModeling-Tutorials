...
ベンチマークでは、JijModeling 2.6.0 に対して最大 8 倍、JijModeling 1.x に対して最大 5 倍の高速化が観測されました。以下は代表的な処理の実行時間を、2.7.0 を 1.0 として比較した結果です。値が大きいほど、今回のリリース版よりも時間がかかったことを示します。
