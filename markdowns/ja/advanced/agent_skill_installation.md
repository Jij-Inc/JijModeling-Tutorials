...
また、同梱のスキルは機能追加などに応じて更新されていきますので、利用する JijModeling のバージョンを変更した場合は、以下で説明するインストール手順を再度繰り返し、必要に応じてスキルを更新することをお勧めします。
...
スキルをインストールするには、まず具体的にどこに配置されているのかを知る必要があります。
